...
severity: down
---
*Details* - Netrocorp, our hosting provider, has reached out that they are moving their current server location to a new one. This affects all of US East. We don't have an exact ETA on when service will be restored. Users should monitor updates from our Discord server to get the most updated information possible.
